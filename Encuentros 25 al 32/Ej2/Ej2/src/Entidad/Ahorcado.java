...
//la cantidad de letras encontradas y la cantidad jugadas máximas que puede realizar el usuario. Definir los siguientes métodos en AhorcadoService:
...
public class Ahorcado {
    ...
    public Ahorcado(char[] palabra, int Long, int encontradas, int jugadaMax) {
